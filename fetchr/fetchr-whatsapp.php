...
foreach ($products as $product) {
  ...
  $order_id = (string)$order_wc->get_order_number();
    ...
    //______________________________________________________________________________________________ WHats app test
    $datalist_wab = array(
        ...
        لقد تم تأكيد طلبك - لسرعة الشحن يرجي اختيار معاد التوصيل من الرابط التالي '.' https://track.fetchr.us/schedule/?tracking_id='.$results->$order_id.'
        كما يمكنك تعقب الطلب في اي وقت من نفس الرابط '
    );
    ...
    //_________________________________________________________________________________________________ whats app test end
